...
namespace WindowsAutomatedSimplifier.RegistryHelper
{
    internal class ShellNotification
    {
        ...
        {
            SHChangeNotify((uint)ShellChangeNotificationEvents.SHCNE_ASSOCCHANGED, (uint)(ShellChangeNotificationFlags.SHCNF_IDLIST |
                ShellChangeNotificationFlags.SHCNF_FLUSHNOWAIT), IntPtr.Zero, IntPtr.Zero);
        }
